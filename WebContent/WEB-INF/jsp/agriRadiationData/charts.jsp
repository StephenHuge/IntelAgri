			...
			<div class="span9" id="content">
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">辐射数据图表</div>
					</div>
					<!-- 左右切换栏 -->
					<div class="">
						<ul class="nav nav-tabs" style="margin: 15px">
							<li><a
								href="<%=request.getContextPath()%>/agriradiation/data/allData">历史数据</a></li>
					...
					<div class="btn-group" style="padding: 15px">
						<button class="btn btn-default dropdown-toggle"
							...
							所有辐射信息<span class="caret"></span>
						</button>
						<ul class="dropdown-menu">
							<li><a
								href="<%=request.getContextPath()%>/agritemperature/data/charts">所有温度信息</a></li>
						</ul>
					</div>
